...
public partial class ProfilesView
{
    ...
    public ProfilesView()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, vm => vm.ShowOnlyNoSpeed, v => v.btnShowOnlyNoSpeed.IsChecked).DisposeWith(disposables);
            ...
            //servers move
            this.OneWayBind(ViewModel, vm => vm.SubItemsForMove, v => v.cmbMoveToGroup.ItemsSource).DisposeWith(disposables);
